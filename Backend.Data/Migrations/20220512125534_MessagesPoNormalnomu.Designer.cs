...
namespace Backend.Data.Migrations
{
    ...
    [Migration("20220512125534_MessagesPoNormalnomu")]
    partial class MessagesPoNormalnomu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessageUserModel", b =>
                {
            ...
            modelBuilder.Entity("MessageUserModel", b =>
                {
                    b.HasOne("Backend.Data.Models.Message", null)
                        .WithMany()
                        .HasForeignKey("MessagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Data.Models.UserModel", null)
                        .WithMany()
